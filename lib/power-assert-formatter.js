...
(function (root, factory) {
    ...
    PowerAssertFormatter.prototype.format = function (context) {
        var outputLines = [],
        ...
        if (this.assertionLocation.path) {
            outputLines.push('# ' + [this.assertionLocation.path, this.assertionLocation.start.line].join(':'));
        } else {
            outputLines.push('# at line: ' + this.assertionLocation.start.line);
        }
        outputLines.push('');
        outputLines.push(this.assertionLine);
