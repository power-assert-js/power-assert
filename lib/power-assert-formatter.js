...
(function (root, factory) {
    ...
    function PowerAssertContextRenderer (dump) {
        this.dump = dump;
    ...
    PowerAssertContextRenderer.prototype.formatLines = function () {
        var lines = [];
    ...
    PowerAssertContextRenderer.prototype.render = function (context) {
    ...
    return {
        ...
        format: function (context) {
            var renderer = new PowerAssertContextRenderer(this.dump);
            var lines = renderer.render(context);
            return lines;
        },
