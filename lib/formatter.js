...
(function (global) {
    ...
    var formatter = function (powerAssertCore) {
        ...
        powerAssertCore.puts = puts;
        powerAssertCore.dump = dump;

        powerAssertCore.events.on('ident', function (value, start, end) {
            idents.push({
                value: value,
                start: start,
                end: end
        ...
        powerAssertCore.events.on('funcall', function (value, start, end) {
            funcalls.push({
                value: value,
                start: start,
                end: end
        ...
        powerAssertCore.events.on('truthy', function (result, line, lineNumber) {
            reset();
        });

        powerAssertCore.events.on('falsy', function (result, line, lineNumber) {
