...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        module.exports = factory(require('./power-assert-core'));
    } else {
        root.empowerQUnit = factory(root.empowerAssert);
    }
}(this, function (enhancer) {
    'use strict';
    ...
    return function (qunit) {
        ...
        var coreApi = enhancer(origQUnitAssert, function (powerOk, context, message, powerAssertText) {
