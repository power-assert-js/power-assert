...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['assert', './power-assert-core', './power-assert-formatter'], factory);
    } else if (typeof exports === 'object') {
        module.exports = factory(require('assert'), require('./power-assert-core'), require('./power-assert-formatter'));
    } else {
        root.assert = factory(root.assert, root.empowerAssert, root.powerAssertFormatter);
    }
}(this, function (baseAssert, enhancer, defaultFormatter) {
    'use strict';
    ...
    var coreApi = enhancer(baseAssert, function (powerOk, context, message) {
