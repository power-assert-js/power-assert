...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.empowerAssertObject = factory(root.powerAssertCore, root.powerAssertFormatter);
    }
    ...
    return function (assertObject, options) {
        extend(config, (options || {}));
        var origAssertObject = extend({}, assertObject);
        var coreApi = enhancer(origAssertObject, config.formatter);
