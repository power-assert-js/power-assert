...
(function (root, factory) {
    ...
    function PowerAssertCompactFormatter (dump) {
        this.dump = dump;
    ...
    PowerAssertCompactFormatter.prototype.format = function (context) {
        var outputLines = [],
    ...
    return {
        ...
        format: function (context) {
            var formatter = new PowerAssertCompactFormatter(this.dump);
            var lines = formatter.format(context);
            return lines;
        },
        PowerAssertCompactFormatter: PowerAssertCompactFormatter
    };
}));
